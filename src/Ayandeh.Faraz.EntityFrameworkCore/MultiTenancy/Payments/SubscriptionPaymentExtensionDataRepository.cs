...
using Ayandeh.Faraz.EntityFrameworkCore.Repositories;

namespace Ayandeh.Faraz.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : FarazRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<FarazDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
