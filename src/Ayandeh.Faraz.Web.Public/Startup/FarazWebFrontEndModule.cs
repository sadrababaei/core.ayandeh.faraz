...
namespace Ayandeh.Faraz.Web.Public.Startup
{
    [DependsOn(
        typeof(FarazWebCoreModule)
    )]
    public class FarazWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FarazWebFrontEndModule(IWebHostEnvironment env, FarazEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FarazWebFrontEndModule).GetAssembly());
        }
    }
}
