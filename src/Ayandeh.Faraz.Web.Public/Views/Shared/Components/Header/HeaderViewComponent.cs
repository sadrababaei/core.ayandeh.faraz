...
using Ayandeh.Faraz.Web.Public.Startup;
using Ayandeh.Faraz.Web.Session;

namespace Ayandeh.Faraz.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FarazViewComponent
    {
