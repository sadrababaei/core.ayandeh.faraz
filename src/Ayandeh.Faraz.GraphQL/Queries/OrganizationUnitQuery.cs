...
using Ayandeh.Faraz.Core.Base;
using Ayandeh.Faraz.Core.Extensions;
using Ayandeh.Faraz.Dto;
using Ayandeh.Faraz.Types;

namespace Ayandeh.Faraz.Queries
{
    public class OrganizationUnitQuery : FarazQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
