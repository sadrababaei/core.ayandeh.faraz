...
using Ayandeh.Faraz.DynamicEntityPropertyValues.Dto;
...
namespace Ayandeh.Faraz.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : FarazAppServiceBase, IDynamicEntityPropertyValueAppService
    {
