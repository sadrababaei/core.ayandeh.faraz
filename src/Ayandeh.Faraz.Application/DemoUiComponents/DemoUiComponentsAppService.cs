...
using Ayandeh.Faraz.DemoUiComponents.Dto;

namespace Ayandeh.Faraz.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : FarazAppServiceBase, IDemoUiComponentsAppService
    {
