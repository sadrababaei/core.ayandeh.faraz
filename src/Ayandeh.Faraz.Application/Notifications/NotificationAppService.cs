...
using Abp.UI;
using Ayandeh.Faraz.Notifications.Dto;

namespace Ayandeh.Faraz.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : FarazAppServiceBase, INotificationAppService
    {
