...
using Ayandeh.Faraz.UiCustomization;
...
{
    public class SessionAppService : FarazAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = FarazConsts.Currency,
                        CurrencySign = FarazConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = FarazConsts.AllowTenantsToChangeEmailSettings,
