...
using Ayandeh.Faraz.Auditing.Exporting;
...
using EntityHistoryHelper = Ayandeh.Faraz.EntityHistory.EntityHistoryHelper;

namespace Ayandeh.Faraz.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FarazAppServiceBase, IAuditLogAppService
    {
