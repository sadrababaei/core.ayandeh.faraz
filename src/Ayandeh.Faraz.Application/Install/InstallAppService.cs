...
namespace Ayandeh.Faraz.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FarazAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FarazDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{FarazConsts.ConnectionStringName}", constring);
        }
