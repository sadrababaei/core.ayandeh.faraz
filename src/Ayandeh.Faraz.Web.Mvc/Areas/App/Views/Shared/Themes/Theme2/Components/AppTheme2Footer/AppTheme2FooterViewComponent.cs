...
namespace Ayandeh.Faraz.Web.Areas.App.Views.Shared.Themes.Theme2.Components.AppTheme2Footer
{
    public class AppTheme2FooterViewComponent : FarazViewComponent
    {
