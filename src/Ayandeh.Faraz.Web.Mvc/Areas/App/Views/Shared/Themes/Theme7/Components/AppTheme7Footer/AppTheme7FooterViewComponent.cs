...
namespace Ayandeh.Faraz.Web.Areas.App.Views.Shared.Themes.Theme7.Components.AppTheme7Footer
{
    public class AppTheme7FooterViewComponent : FarazViewComponent
    {
