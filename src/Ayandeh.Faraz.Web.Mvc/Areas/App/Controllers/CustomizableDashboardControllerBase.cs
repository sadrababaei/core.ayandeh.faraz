...
using Ayandeh.Faraz.Web.Areas.App.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : FarazControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = FarazDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
