...
using Ayandeh.Faraz.Authorization.Accounts;
using Ayandeh.Faraz.Authorization.Accounts.Dto;
...
using Ayandeh.Faraz.Net.Sms;
using Ayandeh.Faraz.Notifications;
using Ayandeh.Faraz.Web.Models.Account;
using Ayandeh.Faraz.Security;
using Ayandeh.Faraz.Security.Recaptcha;
using Ayandeh.Faraz.Sessions;
using Ayandeh.Faraz.Url;
using Ayandeh.Faraz.Web.Authentication.External;
using Ayandeh.Faraz.Web.Security.Recaptcha;
using Ayandeh.Faraz.Web.Session;
using Ayandeh.Faraz.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace Ayandeh.Faraz.Web.Controllers
{
    public class AccountController : FarazControllerBase
    {
