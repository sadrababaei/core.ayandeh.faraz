...
namespace Ayandeh.Faraz.Web.TagHelpers
{
    ...
    public class FarazPageSubheaderTagHelper : TagHelper
    {
        ...
        public FarazPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
