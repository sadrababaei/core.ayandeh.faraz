...
using Ayandeh.Faraz.Identity;
using Ayandeh.Faraz.Schemas;
using Ayandeh.Faraz.Web.Chat.SignalR;
using Ayandeh.Faraz.Web.Common;
using Ayandeh.Faraz.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Ayandeh.Faraz.Web.IdentityServer;
using Ayandeh.Faraz.Web.Swagger;
using Stripe;
...
using Ayandeh.Faraz.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Ayandeh.Faraz.Web.Extensions;
using SecurityStampValidatorCallback = Ayandeh.Faraz.Identity.SecurityStampValidatorCallback;
...
namespace Ayandeh.Faraz.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<FarazWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Faraz API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Ayandeh.Faraz.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Faraz API", Version = "v1"});
                ...
                var applicationXml = $"Ayandeh.Faraz.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Ayandeh.Faraz.Web.Core.xml";
