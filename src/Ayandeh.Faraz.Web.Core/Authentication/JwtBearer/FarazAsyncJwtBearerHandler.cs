...
namespace Ayandeh.Faraz.Web.Authentication.JwtBearer
{
    public class FarazAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public FarazAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
