...
using Ayandeh.Faraz.Authentication.TwoFactor;
...
using Ayandeh.Faraz.Web.Authentication.JwtBearer;
using Ayandeh.Faraz.Web.Authentication.TwoFactor;
using Ayandeh.Faraz.Web.Chat.SignalR;
using Ayandeh.Faraz.Web.Common;
using Ayandeh.Faraz.Web.Configuration;
using Ayandeh.Faraz.Web.DashboardCustomization;

namespace Ayandeh.Faraz.Web
{
    [DependsOn(
        typeof(FarazApplicationModule),
        typeof(FarazEntityFrameworkCoreModule),
    ...
    public class FarazWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FarazWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FarazApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FarazWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(FarazWebCoreModule).Assembly);
        }
