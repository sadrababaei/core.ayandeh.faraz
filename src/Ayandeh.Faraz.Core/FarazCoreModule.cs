...
using Ayandeh.Faraz.Authorization.Ldap;
...
using Ayandeh.Faraz.DashboardCustomization.Definitions;
using Ayandeh.Faraz.Debugging;
using Ayandeh.Faraz.DynamicEntityProperties;
using Ayandeh.Faraz.Features;
using Ayandeh.Faraz.Friendships;
using Ayandeh.Faraz.Friendships.Cache;
using Ayandeh.Faraz.Localization;
using Ayandeh.Faraz.MultiTenancy;
using Ayandeh.Faraz.Net.Emailing;
...
{
    [DependsOn(
        typeof(FarazCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FarazCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FarazLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FarazConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FarazMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FarazSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FarazCoreModule).GetAssembly());
        }
