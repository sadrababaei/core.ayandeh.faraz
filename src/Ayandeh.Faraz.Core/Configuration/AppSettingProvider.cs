...
using Ayandeh.Faraz.Authentication;
...
namespace Ayandeh.Faraz.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!FarazConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        FarazConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    FarazDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    FarazDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = FarazDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = FarazDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = FarazDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        FarazDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = FarazDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = FarazDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        FarazDashboardCustomizationConsts.Widgets.Host
