...
namespace Ayandeh.Faraz.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FarazServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Ayandeh.Faraz", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
