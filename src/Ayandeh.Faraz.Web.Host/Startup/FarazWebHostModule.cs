...
using Ayandeh.Faraz.Web.Startup.ExternalLoginInfoProviders;
...
namespace Ayandeh.Faraz.Web.Startup
{
    ...
    public class FarazWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FarazWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FarazWebHostModule).GetAssembly());
        }
