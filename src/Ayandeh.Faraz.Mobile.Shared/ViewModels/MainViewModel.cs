...
using Ayandeh.Faraz.Commands;
using Ayandeh.Faraz.Core.Threading;
using Ayandeh.Faraz.Models.NavigationMenu;
using Ayandeh.Faraz.Services.Navigation;
using Ayandeh.Faraz.ViewModels.Base;
using Plugin.Media;
...
using Ayandeh.Faraz.ApiClient;
using Ayandeh.Faraz.Controls;
using Ayandeh.Faraz.Dto;
using Ayandeh.Faraz.Extensions;
using Ayandeh.Faraz.Localization;
using Ayandeh.Faraz.UI;
using Ayandeh.Faraz.UI.Assets;
using Ayandeh.Faraz.Views;
using DependencyResolver = Ayandeh.Faraz.Core.Dependency.DependencyResolver;

namespace Ayandeh.Faraz.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Faraz";
