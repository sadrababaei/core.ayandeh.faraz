...
$webMvcFolder = Join-Path $slnFolder "src/Ayandeh.Faraz.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Ayandeh.Faraz.Web.Public"
...
dotnet restore Ayandeh.Faraz.Web.sln
