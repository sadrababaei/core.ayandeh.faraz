...
using Ayandeh.Faraz.MultiTenancy.HostDashboard;
...
namespace Ayandeh.Faraz.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(FarazDbContext context, SubscriptionPayment subscriptionPayment)
        {
